...
import type { RuleRepository } from '../repositories/rule-repository.ts'
...
export async function deleteCategoryAndReassign(
  ...
  repositories: { categories: CategoryRepository; transactions: TransactionRepository; rules: RuleRepository },
): Promise<number> {
